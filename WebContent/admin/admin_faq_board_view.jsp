...
<section class="section w3-container">   
			...
			<c:forEach var="answer" items="${answer }">
				<tr>
					...
					<td>${answer.nick }&nbsp;<fmt:formatDate value="${answer.writedate }"/><br><br>
						...
						onclick="location.href='AdminServlet?command=admin_FAQ_answer_delete&num=${answer.num}&fr_num=${answer.fr_num}'">
					</td>
				</tr>	
			</c:forEach>		
			</table>
			<form action="AdminServlet" method="get">
				<input type="hidden" name="command" value="admin_FAQ_answer">
		...
		<br>
		<footer class="footer">
		<input type="button" value="목록보기" onclick="location.href='AdminServlet?command=admin_faq_board_list'"/>		</footer>
	</section>			
</body>
</html>