...
<body>
	<div id="wrap" align="center">
		<h1>게시글 등록</h1>
		<form action="AdminServlet" method="post" name="frm">
			<input type="hidden" name="command" value="admin_notice_board_update" /> <input
			...
			<input type="button" value="목록보기"
				onclick="location.href='AdminServlet?command=admin_notice_board_list'" />
