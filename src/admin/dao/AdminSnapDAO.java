...
public class AdminSnapDAO {

	private AdminSnapDAO() {

	}

	private static AdminSnapDAO instance = new AdminSnapDAO();

	public static AdminSnapDAO getInstance() {
		return instance;
	}

	public void insertSnap(BoardVO vo) {
		String sql = "insert into board(num, title, content, image, category, nick, age) values"
				+ "(board_seq.nextval, ?, ?, ?, ?, ?, ?)";
